...
export default async function handler(req,res){
  ...
  try{
    ...
    const activity=clean(call.input,responseMode);const usage=data.usage||{};console.log(`[activity-ai] uid:${decoded.uid} model:${MODEL} in:${usage.input_tokens||0} out:${usage.output_tokens||0}`);
