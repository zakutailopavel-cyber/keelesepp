  ...
  return {
    ...
    stages:[
      {id:'school-vocabulary',title:'1. Koolisõnad',workspaceType:'vocabulary',minutes:10,skill:'vocabulary',checkpoint:'Neli sihtsõna peavad jõudma õpilase enda lausetesse.',routes:{
        support:variant('Kasuta esimest kuut kaarti. Õpilane näeb tõlget ja näidet; seejärel peida tugi.', [{id:'school-vocabulary-0',prompt:'Ütle, milline kaart tähendab урок, учитель, домашняя работа ja оценка. Seejärel ütle need neli sõna kaarte vaatamata.'},{id:'school-vocabulary-1',prompt:'Koosta iga nelja sihtsõnaga lause oma õppimise kohta. Võid esmalt vaadata kaardi näidet.'}]),
        core:variant('Kasuta kümmet kaarti. Tõlge avaneb ainult vajadusel; lõpuks sulge kaardid.', [{id:'school-vocabulary-0',prompt:'Selgita sõnu tund, õpetaja, kodutöö ja hinne eesti keeles või too näide.'},{id:'school-vocabulary-1',prompt:'Räägi oma koolipäevast kuue lausega. Kasuta kõiki nelja sihtsõna ja veel kahte kaardisõna.'}]),
        advanced:variant('Kasuta kõiki kaarte ilma tõlketa. Küsi täpsemat tähendust ja isiklikke näiteid.', [{id:'school-vocabulary-0',prompt:'Selgita kõiki nelja sihtsõna ning erinevust: õppima / õpetama ja hinne / hind.'},{id:'school-vocabulary-1',prompt:'Võrdle kaht õppimisviisi kaheksa lausega, kasutades sihtsõnu ning sõnu tagasiside ja tähtaeg.'}])}},
      {id:'school-grammar',title:'2. Õpin ja pean tegema',workspaceType:'controlled_practice',minutes:12,skill:'grammar',checkpoint:'Pean + ma-tegevusnimi; õpin ja õpetan erinevad; sest seob põhjuse.',routes:{
        support:variant('Loe olukorrad ette ja näita lausealguseid. Küsi iga lause tähendust.', [{id:'school-grammar-0',prompt:'Lõpeta: Ma … eesti keelt. Õpetaja … eesti keelt. Homme on kontrolltöö: ma pean täna … .'},{id:'school-grammar-1',prompt:'Ütle kaks lauset: pead kodutöö tegema; vajad abi, sest ülesanne on raske. Kasuta nähtavaid lausealguseid.'}]),
        core:variant('Õpilane loob laused ise. Lausealguseid võib vaadata pärast esimest katset.', [{id:'school-grammar-0',prompt:'Paranda ja selgita: Mina õpetab eesti keelt. Ma pean teen kodutöö. Õpetaja õpib mulle uut sõna.'},{id:'school-grammar-1',prompt:'Ütle kolm seotud lauset: mida õpid, mida pead homseks tegema ja miks küsid õpetajalt abi.'}]),
        advanced:variant('Peida mudelid. Küsi nii paranduse põhjust kui uut isiklikku näidet.', [{id:'school-grammar-0',prompt:'Sõnasta ümber ja põhjenda parandusi: Ma pean teen ülesanne. Õpetaja õpib mulle grammatikat. Ma küsin abi miks see on raske.'},{id:'school-grammar-1',prompt:'Võrdle tänast ja homset õppimist nelja lausega; kasuta pean ja sest ning esita viisakas täpsustav küsimus.'}])}},
      {id:'school-speaking',title:'3. Vestlus õpetajaga',workspaceType:'roleplay',minutes:10,skill:'speaking',routes:{
        support:variant('Sina oled õpetaja. Kodutöö on õpikust ülesanne 4, tähtaeg homme. Ütle need detailid ainult siis, kui õpilane küsib. Vajadusel tuleta meelde küsimise sammu.', [{id:'school-speaking-0',prompt:'Sa puudusid tunnist. Küsi õpetajalt, mida kodus teha ja mis ajaks. Täpsusta üht detaili ja korda kokkulepe oma sõnadega.'}]),
        core:variant('Sina oled õpetaja. Ülesanne 4 tuleb teha homseks; vastused tuleb kirjutada vihikusse. Vasta küsimustele ja küsi: „Kuidas sa kontrollid, et said ülesandest aru?”', [{id:'school-speaking-0',prompt:'Sa puudusid tunnist. Pea õpetajaga vähemalt nelja vooruga vestlus: uuri kodutööd ja tähtaega, küsi täpsustust ning kinnita järgmine samm.'}]),
        advanced:variant('Sina oled õpetaja. Kodutöö tähtaeg on homme. Poole vestluse pealt ütle, et esialgset ülesannet on muudetud: nüüd tuleb teha ülesanne 5. Palu õpilasel uus kokkulepe sõnastada.', [{id:'school-speaking-0',prompt:'Uuri puudutud tunni kodutööd. Selgita, miks sa vajad täpsustust, reageeri muudetud ülesandele ja lepi kokku järgmine samm.'}])}},
      {id:'school-transfer',title:'4. Uuel kursusel',workspaceType:'transfer',minutes:8,skill:'speaking',routes:{
        support:variant('Uus kontekst on täiskasvanute veebikursus. Sa oled kursuse juhendaja. Õppija peab tegema helisalvestise reedeks; hinnet ei panda, antakse tagasisidet. Avalda üks detail korraga pärast küsimust.', [{id:'school-transfer-0',prompt:'Alustad veebikursust. Uuri, mida õppimiseks teha, millal töö esitada ja kuidas saad teada, kas said hakkama. Lõpuks ütle oma plaan.'}]),
        core:variant('Sina oled veebikursuse juhendaja. Helisalvestis tuleb esitada reedeks; numbrihinde asemel antakse tagasisidet. Ära korda varasema koolivestluse lauseid.', [{id:'school-transfer-0',prompt:'Alustad uut veebikursust. Uuri ülesannet, tähtaega ja hindamist. Võrdle saadud vastuse põhjal kursust oma senise õppimisega.'}]),
        advanced:variant('Sina oled veebikursuse juhendaja. Töö on reedeks, hinnet asendab tagasiside. Lisa komplikatsioon: õppijal ei tööta mikrofon; paku kirjalikku alternatiivi alles pärast tema ettepanekut.', [{id:'school-transfer-0',prompt:'Alustad veebikursust, kuid üks õppevahend ei tööta. Uuri töö eesmärki ja hindamist, paku alternatiiv ning põhjenda, kuidas see aitab sul õppida.'}])}},
      ...['vocabulary','grammar','speaking'].map((skill,index)=>({
        ...
        routes:Object.fromEntries(['support','core','advanced'].map(route=>[route,variant(
          ...
          [{id:`school-assessment-${skill}-0`,prompt:[
